...
'''nextpa[i]=i if the regular expression at position i is not '('
   nextpa[i]=j if the regular expression at position i is '(' and
   jth position holds the corresponding ')'
'''
nextpa = [0]*100
...
# unite two Epsilon-NFAs, with start state s1 and s2,
# final state t1 and t2, respectively.
# return an array of length 2, where the first element is 
# the start state of the combined NFA, the second being the final state.
...
# concatenation of two Epsilon-NFAs, with start state s1 and s2,
# final state t1 and t2, respectively.
# return an array of length 2, where the first element is
#  the start state of the combined NFA, the second being the final state. 
...
# return an array of length 2, where the first element is
# the start state of the closure Epsilon-NFA, the second being the final state.
def clo(s,t):
    st=[0]*2
